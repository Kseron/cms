...
<form action='' method='post' enctype='multipart/form-data'>
	...
	<tr><td class='left_td'>mini_decsription</td> <td><textarea name="mini_descr" style="width:100%;"><? if($_POST["mini_descr"] != "") { echo $_POST["mini_descr"];} else { echo $my_pages->this_page['mini_descr']; } ?></textarea></td></tr>
