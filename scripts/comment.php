...
$emailadmin = 'royalland@mail.ru';//e-mail админа
$mes = "Человек по имени $name отправил Вам сообщение. ТEKCT СООБЩЕНИЯ: $comtext. А также прислал свой НОМЕР ТЕЛЕФОНА: $phone";

$from = $email;
$to = $emailadmin;
$sub = "Сообщение с сайта www.GipsMontaj.ru от $name";
...
$ok ="<p style='font-family:Verdana; font-size:12px; border:2px solid #f5f5f5; padding:10px; margin:20px; background-color:#ffffff;'><strong>Спасибо, $name! Ваше сообщение отправлено!</strong></p>";
