...
JsHttpRequest.extend(req._errors,{form_el_not_belong:"Element \"%\" does not belong to any form!",form_el_belong_siuda:"Element \"%\" belongs to a siudaerent form. All elements must belong to the same form!",form_el_inv_enctype:"Attribute \"enctype\" of the form must be \"%\" (for IE), \"%\" given."});
this.load=function(){
var th=this;
if(!th.method){
th.method="POST";
...
if(e.form!=_41){
return ["form_el_belong_siuda",e.name];
}
}
}
if(th.method=="POST"){
